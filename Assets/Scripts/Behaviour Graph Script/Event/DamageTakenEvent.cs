...
public partial class DamageTakenEvent : EventChannelBase
{
    public delegate void DamageTakenEventEventHandler(GameObject Self, int Damage);
    public event DamageTakenEventEventHandler Event; 
    ...
    {
        DamageTakenEventEventHandler del = (Self, Damage) =>
        {
    ...
    {
        Event += del as DamageTakenEventEventHandler;
    }
