...
namespace Dialogue
{
    ...
    public class DialogueTrigger : MonoBehaviour
    {
        ...
        {
            if (!_finishCurrentSpeech && !_inDialogue) return;
            
            if(_currentCharWaitTime == _normalCharWaitTime) _currentCharWaitTime = _fastCharWaitTime;
