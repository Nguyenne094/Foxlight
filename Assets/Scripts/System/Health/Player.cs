...
namespace Bap.System.Health
{
    public class Player : Health
    {
        ...
        [Header("Effects")]
        [SerializeField] private float _reviveAfter;
        [SerializeField, Tooltip("Push force for TakeDamage effect")] private float _pushForce;
        ...
        private void TakeDamageFromHazard(Transform subject)
        {
            ...
            {
                transform.position = GameManger.Instance.LastCheckPoint;
            });
        }
