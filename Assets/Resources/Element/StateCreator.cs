...
namespace Bap.State_Machine
{
    public class StateCreator : VisualElement
    {
        ...
        // public class UxmlElementTraits : UxmlTraits
        // {
        //     // Define any traits or attributes for the UXML element here if needed.
        // }
        //
        // public class UxmlElementAttribute : UxmlFactory<StateCreator, UxmlElementTraits>
        // {
        // }

        #endregion

        private new TextField name => this.Q<TextField>("TextField--Name");
